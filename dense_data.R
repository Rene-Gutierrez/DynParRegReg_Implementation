##################################################
### Creates Data According for a Dense Setting ###
##################################################
...
### Parameter Settings
n           = 20        # Observations per Batch or Period
batNum      = 500       # Number of Batches or Periods
numCoe      = 5         # Number of Coefficients in Each Division
...
### Complete Random
prefix = "complete"
rb     = runif(p, -1, 1)    # Real value of the coefficients
...
for(i in 1:9)
{
  ...
  gr1 = sample(seq(1,p),1)                       # Random Selected Parameter for Analysis
